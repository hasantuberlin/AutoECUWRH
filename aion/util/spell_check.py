...
class SpellCorrector(SpellCheck):
    ...
    def correction(self, word):
        ...
        #print(k)
        for item in k:
            word_prob[item]=self.P(item)
        #print(word_prob)
        kamrul=max(word_prob.items(), key=operator.itemgetter(1))
        #print(self.P)
        #kamrul=max(k, key=self.P)
        #print(kamrul)
        return kamrul[0], kamrul[1]
    ...
    def edits1(self, word):
        ...
        return set(replaces) #inserts +deletes
